            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="submit" name="submit" value="Ubah Password" class="button button-green" onclick="return confirm('Yakin Ingin Mengubah Password?')">
                    </form>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($pass2 != $pass1) {
                                ...
                                if($update){
                                    ...
                                    echo 'Ubah Password Gagal'.mysqli_error($koneksi);
                                }
                            }   
                        }
                    ?>
