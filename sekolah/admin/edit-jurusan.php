...
<?php
    $jurusan   = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE id = '".$_GET['id']."' ");
            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="keterangan" id="keterangan" placeholder="Keterangan" class="input-control"><?= $p->keterangan ?></textarea>
                        </div>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($_FILES['gambar']['name'] != ''){
                                ...
                                if(!in_array($formatfile, $allowedtype)) {
                                    ...
                                    echo '<div class="alert alert-error">Ukuran file max. 1 MB.</div>';
