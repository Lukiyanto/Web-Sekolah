                ...
                <div class="box-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" name="nama" placeholder="Nama Universitas" value="<?= $d->nama ?>" class="input-control" required>
                        </div>

                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" name="email" placeholder="Email Universitas" value="<?= $d->email ?>" class="input-control" required>
                        </div>

                        <div class="form-group">
                            <label>Telepon</label>
                            <input type="text" name="telp" placeholder="Telepon Universitas" value="<?= $d->telepon ?>" class="input-control" required>
                        </div>

                        <div class="form-group">
                            <label>Alamat</label>
                            <textarea name="alamat" placeholder="Alamat" class="input-control"><?= $d->alamat ?></textarea>
                        </div>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            if($_FILES['logo_baru']['name'] != ''){
                                ...
                                if(!in_array($formatfile_logo, $allowedtype_logo)) {
                                    ...
                                    echo '<div class="alert alert-error">Ukuran file logo max. 1 MB.</div>';
                            ...
                            if($_FILES['favicon_baru']['name'] != ''){
                                ...
                                if(!in_array($formatfile_favicon, $allowedtype_favicon)) {
                                    ...
                                    echo '<div class="alert alert-error">Ukuran file favicon max. 1 MB.</div>';
                            ...
                            if($update){
                                echo "<script>window.location='identitas-universitas.php?success=Edit Data Berhasil'</script>";
                            }else{
